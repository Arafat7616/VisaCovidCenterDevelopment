...
{
    public function pcr(){
        $pcrTests = PcrTest::where('registration_type', 'premium')->where('rapid_pcr_center_id', Auth::user()->rapid_pcr_center_id)->where('rapid_pcr_result', null)->orderBy('created_at', 'DESC')->get();
