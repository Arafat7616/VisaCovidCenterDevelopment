...
{
    public function pcr(){
        $pcrTests = PcrTest::where('registration_type', 'normal')->where('rapid_pcr_center_id', Auth::user()->rapid_pcr_center_id)->whereDate('sample_collection_date', '>=', Carbon::today())->orderBy('sample_collection_date', 'ASC')->get();
