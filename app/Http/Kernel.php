...
use App\Http\Middleware\RapidPCRCenterReceptionist;
use App\Http\Middleware\RapidPCRCenterTrustedMedicalAssistant;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'rapidPcrCenterReceptionist' => RapidPCRCenterReceptionist::class,
        'rapidPcrCenterTrustedMedicalAssistant' => RapidPCRCenterTrustedMedicalAssistant::class,
    ];
}
