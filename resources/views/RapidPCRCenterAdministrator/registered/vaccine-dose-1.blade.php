                                ...
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <div class="accorion-link mt-2" id='active-div'>
                                            ...
                                            <a href="{{ route('rapidPcrCenterAdministrator.registered.vaccine.dose1') }}" class="accorion-btn breadcrumb-active">Vaccine Dose 1</a>
                                            <a href="{{ route('rapidPcrCenterAdministrator.registered.vaccine.dose2') }}" class="accorion-btn">Vaccine Dose 2</a>
            ...
            $('.swap-now-btn').click(function (){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: "{{ route('rapidPcrCenterAdministrator.registered.vaccine.swapDose1') }}",
