                                ...
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <div class="accorion-link mt-2" id='active-div'>
                                            ...
                                            <a href="{{ route('rapidPcrCenterAdministrator.registered.booster') }}" class="accorion-btn breadcrumb-active">Booster</a>
                                        </div>
                                    </div>
                                    <div class="col-4">
            ...
            $('.swap-now-btn').click(function (){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: "{{ route('rapidPcrCenterAdministrator.registered.booster.swap') }}",
