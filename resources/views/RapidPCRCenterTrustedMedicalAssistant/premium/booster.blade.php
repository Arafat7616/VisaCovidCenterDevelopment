                        ...
                        <div class="row justify-content-between">
                            <div class="col-4">
                                <div class="accorion-link mt-2" id='active-div'>
                                    ...
                                    <a href="{{ route('rapidPcrCenterTrustedMedicalAssistant.premium.booster') }}" class="accorion-btn  breadcrumb-active">Booster</a>
                                </div>
                            </div>
                            <div class="col-4">
                                    ...
                                    <tbody>
                                        @foreach ($boosterOrderByDate as $booster)
                                            <tr class="table-row">
                                                ...
                                                <td>
                                                    <a href="{{ route('rapidPcrCenterTrustedMedicalAssistant.payment.takePaymentFromUser', [$booster->user_id, 'premium-booster']) }}"><i class="fa fa-sign-in-alt" style="font-size: 36px;"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
