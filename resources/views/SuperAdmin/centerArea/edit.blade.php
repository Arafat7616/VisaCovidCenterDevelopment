                                ...
                                <div class="col-xs-12">
                                    <form role="form" action="{{route('superAdmin.centerArea.update', $centerArea->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="furniture_and_others" value="{{ $centerArea->furniture_and_others }}" class="form-control @error('furniture_and_others') is-invalid @enderror" id="ex1" placeholder="Furniture and other's">
                                        </div>
