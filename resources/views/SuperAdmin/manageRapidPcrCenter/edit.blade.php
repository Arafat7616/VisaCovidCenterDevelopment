                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hotline" class="form-control" id="hotline" value="{{ $rapidPcrCenter->hotline }}">
                                    </div>    
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="center_area" required="" id="center_area">
                                            ...
                                            @foreach($rapidPcrCenterAreas as $center_area)
                                                <option {{$rapidPcrCenter->center_area_id == $center_area->id ? 'selected' : ''}} value="{{$center_area->id}}">{{ $center_area->title }} ({{ $center_area->minimum_space }}-{{ $center_area->maximum_space }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="space" class="form-control" id="space" value="{{ $rapidPcrCenter->space }}">
                                    </div>    
                                </div>
                            </div>
                        </div>
