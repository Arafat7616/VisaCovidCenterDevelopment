        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Premium Vaccination list</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{route('superAdmin.dashboard')}}">Dashboard</a></li>
                        <li><a href="javascript:void(0)">Manage Vaccination</a></li>
                        <li class="active">Premium Vaccination list</li>
                    </ol>
            ...
            <div class="col-md-12">
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <h3 class="panel-title text-white">Premium Vaccination list</h3>
                    </div>
                           ...
                           <thead>
                            ...
                            <tbody>
                                ...
                                <tr>                                  
                                    ...
                                    <td class="td_new">
                                        <a href="{{ route('superAdmin.vaccination.premium.edit', $vaccination->id) }}"
                                        class="btn btn-info"><i class="fa fa-edit"></i> </a>

                                    <button class="btn btn-danger" onclick="delete_function(this)"
                                        value="{{ route('superAdmin.vaccination.premium.destroy', $vaccination) }}"><i
