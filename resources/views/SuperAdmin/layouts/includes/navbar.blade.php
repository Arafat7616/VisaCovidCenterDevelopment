            ...
            <ul>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{route('superAdmin.manageUser.trustedMedicalAssistant')}}" class="waves-effect {{\Illuminate\Support\Facades\Request::is('super-admin/manage-user/trusted-medical-assistant') ? 'active': ''}}"><i class="fa fa-arrow-circle-right"></i><span> Trusted Medical Assistant</span></a></li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{route('superAdmin.synchronize.ruleBasedOnConuntry')}}" class="waves-effect {{\Illuminate\Support\Facades\Request::is('super-admin/synchronize-rule-based-on-conuntry') ? 'active': ''}}"><i class="fa fa-arrow-circle-right"></i><span>Synchronize rule based on country</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
