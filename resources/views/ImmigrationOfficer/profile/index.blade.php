...
@section('content')
    <!-- Main Page Starts -->
    <div class="administrator-profile py-5">
        <div class="container">
            <h5 class="profile__title">Officer Profile</h5>
                    ...
                    <div class="card profile-card">
                        <div class="card-body">
                            <div class="text-center">
                                <img class="card-img profile-card-image" src="{{ asset($user->image ?? get_static_option('no_image')) }}" alt="Card image cap">
                            ...
                            <div class="profile-details row">
                                ...
                                <button class="mt-5 btn btn-lg w-100 btn-primary logout-btn"> 
                                    <span class="mx-2"><i class="fa fa-sign-out"></i></span>Logout
                                </button>
                            </div>
                        </div>
                    </div>
