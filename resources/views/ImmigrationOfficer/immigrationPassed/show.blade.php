        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card w-75 my-3">
                    <img src="{{ asset($immigrationPass->passedUser->image ?? get_static_option('no_image')) }}" class="card-img-top img-fluid spy-card" alt="User Image">
                    <div class="card-body">
                        <div class="card-title">
                            <h6 class="text-muted info-font">Name</h6>
                            <h5 class="info-font">{{ $immigrationPass->passedUser->name }}</h5>
                            <h6 class="text-muted info-font">Passport</h6>
                            <h5 class="info-font">{{ $immigrationPass->passedUser->userInfo->passport_no }}</h5>
                        </div>
                        <h6 class="text-muted">Status</h6>
                        <div class="text-center">
                            <button class="btn {{ $immigrationPass->passedUser->vaccination->date_of_first_dose ? 'btn-success' : 'btn-danger' }}">Vaccine-1</button>
                            <button class="btn {{ $immigrationPass->passedUser->vaccination->date_of_second_dose ? 'btn-success' : 'btn-danger' }} m-1">Vaccine-2</button>
                            <button class="btn {{ $immigrationPass->passedUser->booster->date ? 'btn-success' : 'btn-danger' }} m-1">Booster</button>
                            <button class="btn {{ $immigrationPass->passedUser->pcrTest->pcr_result == 'negative' ? 'btn-success' : 'btn-danger' }}">PCR</button>
                        </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-8 d-flex">
                                        <img src="{{ asset($immigrationPass->passedUser->image ?? get_static_option('no_image')) }}" height="100px" width="100px" alt="">
                                        <div class="information-card p-2">
                                            <h3 class="info-font">{{ $immigrationPass->passedUser->name }}</h3>
                                            <h5 class="info-font">{{ $immigrationPass->passedUser->userInfo->present_address }}</h5>
                                            <h6 class="info-font">{{ $immigrationPass->passedUser->phone }}</h6>
                                        </div>
                                    </div>
                                    <div class="col-md-4 d-flex justify-content-center mt-1">
                                        <div class="content ">
                                            ...
                                            <div class="qr mt-3">
                                                {!! QrCode::size(160)->generate(route('share.user', ['id' => Crypt::encrypt($immigrationPass->passedUser->id)])) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-8 details-card-info">
                                        <div class="row">
                                            <div class="col-md-8 p-2">
                                                ...
                                                <h6>{{ $immigrationPass->passedUser->vaccination->name_of_vaccine }}</h6>
                                                <h6>Received at : {{ $immigrationPass->passedUser->vaccination->center->name }}</h6>
                                                <h6>{{ Carbon\Carbon::parse($immigrationPass->passedUser->vaccination->date_of_first_dose)->format('d M Y') }}</h6>
                                                @endif
                                            </div>
                                            <div class="col-md-4 ">
                                                @if ($immigrationPass->passedUser->vaccination->date_of_first_dose)
                                    ...
                                    <div class="col-md-8 details-card-info2">
                                        <div class="row">
                                            <div class="col-md-8 p-2">
                                                ...
                                                <h6>{{ $immigrationPass->passedUser->vaccination->name_of_vaccine }}</h6>
                                                <h6>Received at : {{ $immigrationPass->passedUser->vaccination->center->name }}</h6>
                                                <h6>{{ Carbon\Carbon::parse($immigrationPass->passedUser->vaccination->date_of_second_dose)->format('d M Y') }}</h6>                                                        
                                                @endif
                                            </div>
                                            <div class="col-md-4 ">
                                                @if ($immigrationPass->passedUser->vaccination->date_of_second_dose)
                                    ...
                                    <div class="col-md-8 details-card-info3">
                                        <div class="row">
                                            <div class="col-md-8 p-2">
                                                ...
                                                <h6>{{ $immigrationPass->passedUser->booster->name_of_vaccine }}</h6>
                                                <h6>Received at : {{ $immigrationPass->passedUser->booster->center->name }}</h6>
                                                <h6>{{ Carbon\Carbon::parse($immigrationPass->passedUser->booster->date)->format('d M Y') }}</h6>
                                                @endif
                                            </div>
                                            <div class="col-md-4 ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 p-2">
                                                @if($immigrationPass->passedUser->pcrTest)
                                                    ...
                                                    <h6>Negative</h6>
                                                    @elseif($immigrationPass->passedUser->pcrTest->pcr_result == 'positive')
                                                    <h6>Positive</h6>
                                                    @else
                                                    <h6>Result Not Published</h6>
                                                    @endif
                                                    <h6>Received at : {{ $immigrationPass->passedUser->pcrTest->center->name }}</h6>
                                                    <h6>{{ Carbon\Carbon::parse($immigrationPass->passedUser->pcrTest->date_of_result_publish)->format('d M Y') }}</h6>
                                                @endif
