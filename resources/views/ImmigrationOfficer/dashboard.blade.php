                    ...
                    <div class="col">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-footer text-center">
                                <a class="btn btn-sm btn-success" href="{{route('immigrationOfficer.trustedPeople.edit', $people->id)}}"><i class="fa fa-edit"></i> Edit</a>
                                <button class="btn btn-sm btn-danger" onclick="delete_function(this)" value="{{ route('immigrationOfficer.trustedPeople.destroy', $people->id) }}"><i class="fa fa-trash"></i> Delete </button>
                            </div>
                        </div>
                    </div>
                    @endforeach
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body volunteers__add">
                            <a href="{{route('immigrationOfficer.trustedPeople.create')}}" class="volunteers__add__icon">
