                                ...
                                <div class="cal-service-slot row">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text" style="white-space:pre">Other's square feet      :  {{ get_center_other_square_feet() }}</p>
                                            ...
                                            <p class="card-text" style="white-space:pre">Maximum capacity : {{ intval((Auth::user()->center->space - get_center_other_square_feet()) / get_static_option('sft_per_person'))}} </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
