...
@section('content')
    ...
    <div class="profile py-5">
        <div class="container">
            <h5 class="profile__title">Center Modify</h5>
            ...
            <div class="card profile-card">
                ...
                <div class="card-body">
                    <form class="form" action="{{ route('administrator.centerModifyPost') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="number" value="{{ $center->space }}" id="space" name="space" class="form-control text-muted"
                                        placeholder='1000' />
                                    </div>
                                    @error('space')
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->name }}" id="centerName" name="centerName" class="form-control text-muted"
                                    ...
                                    <div class="col-8">
                                        <select class="form-control form-select text-muted" name="country" id="country">
                                            ...
                                            @foreach ($countries as $country)
                                                <option @if($country->id == $center->country_id) selected @endif value="{{ $country->id }}">{{ $country->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('country')
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="number" value="{{ $center->waiting_seat_capacity }}" id="waitingSeatCapacity" name="waitingSeatCapacity" class="form-control text-muted"
                            ...
                            <div class="col-md-6">
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->zip_code }}" id="zipCode" name="zipCode" class="form-control text-muted"
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->hotline }}" id="hotline" name="hotline" class="form-control text-muted"
                                        placeholder='HotLine' />
                                    </div>
                                    @error('hotline')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->email }}" id="centerEmail" name="centerEmail" class="form-control text-muted"
                                        placeholder='Email' />
                                    </div>
                                    @error('centerEmail')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->address }}" id="address" name="address" class="form-control text-muted"
                                        placeholder='Address' />
                                    </div>
                                    @error('address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-8">
                                        <input type="text" value="{{ $center->map_location }}" id="mapLocation" name="mapLocation" class="form-control text-muted"
