                                ...
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <div class="accorion-link mt-2" id='active-div'>
                                            ...
                                            <a href="{{ route('administrator.premiumRegistered.vaccine.dose1') }}" class="accorion-btn breadcrumb-active">Vaccine Dose 1</a>
                                            <a href="{{ route('administrator.premiumRegistered.vaccine.dose2') }}" class="accorion-btn">Vaccine Dose 2</a>
            ...
            $('.swap-now-btn').click(function (){
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: "{{ route('administrator.premiumRegistered.vaccine.swapDose1') }}",
